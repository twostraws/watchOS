...
class GameScene: SKScene, WKCrownDelegate, SKPhysicsContactDelegate {
    ...
    var leftEdge = SKSpriteNode(color: .white, size: CGSize(width: 10, height: 150))
    var rightEdge = SKSpriteNode(color: .white, size: CGSize(width: 10, height: 150))
    var topEdge = SKSpriteNode(color: .white, size: CGSize(width: 150, height: 10))
    var bottomEdge = SKSpriteNode(color: .white, size: CGSize(width: 150, height: 10))
